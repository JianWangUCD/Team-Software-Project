...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof org.jhipster.blog.service.EmailAlreadyUsedException ||
            ex instanceof org.jhipster.blog.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof org.jhipster.blog.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
