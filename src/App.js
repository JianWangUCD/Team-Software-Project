...
import SaleSoon from './pages/SaleSoon';
import SaleNowPage from './pages/SaleNowPage';
      ...
      <Navbar />
        <main>
          <Routes>
            ...
            <Route path="/todaysSale" Component={SaleSoon} exact></Route>
            <Route path="/saleNow" Component={SaleNowPage} exact></Route>
